...
IF( OSG_LIBRARY_DEBUG AND OSG_INCLUDE_DIR )
    SET( OSG_FOUND "YES" )
    SET( OSG_INCLUDE_DIRS ${OSG_INCLUDE_DIR} ${OSG_GEN_INCLUDE_DIR} )
    GET_FILENAME_COMPONENT( OSG_LIBRARIES_DIR ${OSG_LIBRARY_DEBUG} PATH )
	...
	SET ( OSGTERRAIN_LIBRARY OSGTERRAIN_LIBRARY_DEBUG )
...
ENDIF( OSG_LIBRARY_DEBUG AND OSG_INCLUDE_DIR )